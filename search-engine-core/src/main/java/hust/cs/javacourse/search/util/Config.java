...
public class Config {
     ...
     * 可通过系统属性 search.engine.home 覆盖
     */
    public static String PROJECT_HOME_DIR = System.getProperty("search.engine.home", System.getProperty("user.dir"));

    /**
     * <pre>
     * 索引文件的目录,以相对路径指定索引文件目录,将索引文件保存在当前工程目录下的index子目录中.
     * 可通过系统属性 search.engine.index.dir 覆盖
     * </pre>
     */
    public static String INDEX_DIR = System.getProperty("search.engine.index.dir", PROJECT_HOME_DIR + "/index/");

    /**
     * <pre>
     *  文本文件的目录,以相对路径指定文本文件目录 ,将文本文件保存在当前工程目录下的text子目录中
     *  可通过系统属性 search.engine.doc.dir 覆盖
     * </pre>
     *
     */
    public static String DOC_DIR = System.getProperty("search.engine.doc.dir", PROJECT_HOME_DIR + "/text/");
